## Visual-Language
시각언어는 시각에 호소해 의지를 소통시키는 언어를 뜻한다. 시각 언어의 종류는 조형예술, 영화, 사진, 텔레비전 등 다양하다. 이것들을 구성하는 각 요소가 시각어이며, 이로부터 시각언어가 성립된다는 사고에서 온 개념이다.    
이러한 사고방식은 근대적인 조형예술의 일반 개념으로, 이전부터 존재해왔지만 케페시의 저서 <시각의 언어(1922)>에서 상세한 규정이 내려졌다. 
...
<img src="https://petapixel.com/assets/uploads/2017/02/04-800x521.jpg" width="40%" height="40%" title="px(픽셀) 크기 설정" alt="10"></img>

예시) 패턴+선형적 요소    
규칙속에서 홀로 수직적인 걸어오는 인물이 눈에 띈다.
...
### Color
각 색에는 인류가 존재해온 오랜시간동안 쌓인 이미지가 있다. 의도하지않아도 자연스럽게 구체적인 물체나 감정 등이 연상되는데, 이러한 상징성을 이용하면 표현하고자하는 것을 전달하기 쉽다. 그에 반해 일반적이지 않게 활용하고자 한다면 혼란스러워 지기 쉬우므로 많은 연구가 필요하다.
...
> 하양-깨끗함, 공허, 영원    
> 검정-죽음, 경건, 절제    
<img src="https://w7.pngwing.com/pngs/669/60/png-transparent-color-wheel-psychology-emotion-color-symbolism-paint-text-color-psychology.png" width="80%" height="80%" title="px(픽셀) 크기 설정" alt="7"></img>

#### 본격적인 색 작업 전 정해두면 좋은 것들

##### color pallet
컬러팔레트에는 주요 색과 강조색을 표시해둔다.    
작업할 때 컬러팔레트를 만들어 두고 기본적인 색에서 벗어나지 않으며 적절히 활용하면 성정한 분위기와 컨셉에서 크게 벗어나지 않을 수 있다.    
...
##### Color wheel, gamut
사용되는 색상의 범위. 같은 이미지라도 사용하는 색상의 범위에 따라 분위기가 확연히 달라지기 때문에 작업 이전에 정해두면 작업 전체적인 분위기와 색감을 통일하기 쉽다.    
